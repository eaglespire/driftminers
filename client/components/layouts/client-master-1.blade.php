        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse order-3" id="navbarCollapse">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a href="{{route('client.profile')}}" class="nav-link @if(route('client.profile') == url()->current()) active @endif">Dashboard</a>
                    </li>
{{--                    <li class="nav-item">--}}
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('client.profile') }}">Dashboard</a></li>
